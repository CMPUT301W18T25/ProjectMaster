...
public class UserController {
    ...
    public String addUserAndCheck(User user){
        ...
        Log.d("UserController","userId return "+userId);
        return userId;
    ...
    public User getAUserById(String userId){
        Log.d("UserController","getAUserById userId: "+userId);
        UserController.getAUserById getAUserById = new UserController.getAUserById();
        ...
        if (Userlist == null){
            Log.d("UserController", "Userlist = null");

        }
        //noinspection ConstantConditions
        if(Userlist.isEmpty()){
            Log.d("UserController", "getAUserById2 return null");
            return null;
        }
        else {
            Log.d("UserController", "getAUserById2 return nonnull");
    ...
    public static class getAUserById extends AsyncTask<String, Void, ArrayList<User>> {
        ...
        protected ArrayList<User> doInBackground(String... search_parameters) {
            verifySettings();
            Log.d("UserController", "getAUserById execute");
            for (int i=0;i<search_parameters.length;i++){
                Log.d("UserController", "search_parameters at "+i+": "+search_parameters[i]);
