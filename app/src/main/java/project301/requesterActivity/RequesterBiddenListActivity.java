...
/**
 * Detail : Requester bidden list is to show a list of bidden task, which support click to get information of task.
 * @Date :   01/04/2018
 * @author : Yingnan Ma
 * @version 1.0
 * @copyright : copyright (c) 2018 CMPUT301W18T25
 * @classname : RequesterBiddenListActivity
 */


@SuppressWarnings({"ALL", "ConstantConditions"})
public class RequesterBiddenListActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RequesterAdapter(this, biddenTaskList);
        ...
        mainMenuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent info2 = new Intent(RequesterBiddenListActivity.this, RequesterMainActivity.class);
        ...
        viewOnMapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent info2 = new Intent(RequesterBiddenListActivity.this, RequesterMapBiddenActivity.class);
                info2.putExtra("userId",userId);
                startActivity(info2);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int index, long r_id) {
                Intent info1 = new Intent(RequesterBiddenListActivity.this, RequesterViewTaskBiddenActivity.class);
    ...
    private void openRequestInfoDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RequesterBiddenListActivity.this);
