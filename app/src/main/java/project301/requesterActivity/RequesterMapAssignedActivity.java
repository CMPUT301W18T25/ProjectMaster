...
public class RequesterMapAssignedActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private static final String TAG = RequesterMapAssignedActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map_assigned);
        mapFragment.getMapAsync(this);

        Button back_assign_Button = (Button) findViewById(R.id.go_back_assign);
        back_assign_Button.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void displayTaskLocations() {
        ...
        for (int i = 0; i < AssignedTaskList.size(); i++) {
            project301.Task currTask = AssignedTaskList.get(i);
            ...
            if (currTask.getTasklgtitude() != null
                ...
                Log.d(TAG, "No location for: " + AssignedTaskList.get(i).getTaskName());
    ...
    public boolean onMarkerClick(Marker marker){
        ...
        project301.Task clickedTask = AssignedTaskList.get(markerIndex);
        ...
        Intent info1 = new Intent(RequesterMapAssignedActivity.this, RequesterViewTaskRequestActivity.class);
    ...
    private void getAllTaksInfo() {
        ...
        for (int i =0;i<AssignedTaskList.size();i++){
            Log.d(TAG,"Requester TASK: "+AssignedTaskList.get(i).getTaskName()+", "+AssignedTaskList.get(i).getTaskStatus());
        }
    }
