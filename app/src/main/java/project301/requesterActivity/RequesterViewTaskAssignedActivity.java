...
/**
 * Detail :RequesterViewTaskAssignedActivity is to allow user to view a target assigned task with related information.
 *
 * @Date :   01/04/2018
 * @author : Yingnan Ma
 * @version 1.0
 * @copyright : copyright (c) 2018 CMPUT301W18T25
 * @classname : RequesterViewTaskAssignedActivity
 */
